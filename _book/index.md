...
I use this page to provide formatting information.


## Chapters or sub-chapters

All chapters start with a first-level heading followed by your chapter title, like the example in the next chapter. There should be only one first-level heading (`#`) per .Rmd file. This page is the homepage, it is a slight  exception as it contains a YAML header with parameters for the whole book.
...
It is up to the user to define the appearance of these blocks for LaTeX output. At hte moment they have only a colored border.

#### Colored box

::: {.bluebox}

This is a blue box. It could be used for notes, remarks, tips or other important hints.
...
This is an orange box. It could be used for warning, or to draw attentions to problems.
:::


::: {.greenbox}

This is a green box. It could be used for success or other positive remarks.
:::
...
This is a grey box. It could be used for code messages.
:::

### Designing own callouts

The R Markdown Cookbook provides more help on how to use custom blocks to design your own callouts: https://bookdown.org/yihui/rmarkdown-cookbook/custom-blocks.html

I have developed the following five callouts:
